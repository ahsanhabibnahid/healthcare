            ...
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="doctor-schedule">
                                ...
                                <hr>
                                <p class="mb-3">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
                                <h4>Availability</h4>
                                <hr>
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-12 col-sm-12 mb-3">
                                        <h6>Monday</h6>
                                        <p>9.00 - 5.00</p>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12 col-sm-12 mb-3">
                        ...
                        <div class="single-doc-tab col-lg-12">
                            <ul id="tabsJustified" class="nav nav-tabs justify-content-left">
                                <li class="nav-item">
                                    <a href="#" data-target="#one" data-toggle="tab" class="nav-link active">
                                        <i class="icofont icofont-graduate-alt"></i>  Experience
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" data-target="#two" data-toggle="tab" class="nav-link">
                                        <i class="icofont icofont-hat-alt"></i> Qualification
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" data-target="#three" data-toggle="tab" class="nav-link">
                                        <i class="icofont icofont-award"></i> Achievement
                                    </a>
                                </li>
                            </ul>
                            <div id="tabsJustifiedContent" class="tab-content mt-4">
                                <div id="one" class="tab-pane animated fadeInRight active show">
                                    <ul>
                                        <li>General Nephrology, Dialysis , Kidney Transplant &amp; Palliative Renal Care</li>
                                        <li>Experience of over 2500 Kidney Transplants over 3 decades</li>
                                        <li>Founder Director of Lorem Nephrology &amp; Transplant Institute(LANTI) since 1991</li>
                                        <li>Former Chief Lorem Ipsum Dollar Hospital</li>
                                    </ul>
                                </div>
                                <div id="two" class="tab-pane animated fadeInRight">
                                    <ul>
                                        <li>Trained Anaesthetist(DNB)</li>
                                        <li>Diploma Preventative and Promotive Healthcare (PPHC)</li>
                                        <li>Post graduate in Sports and Exercise Medicine (UK)</li>
                                        <li>High Altitude Mountain Medicine ( Army ,Leh)</li>
                                    </ul>
                                </div>
                                <div id="three" class="tab-pane animated fadeInRight">
                                    <ul>
                                        <li>Was the first national to be invited to be part of 6 member British medical Team for the ‘Everest Marathon 2013’.</li>
                                        <li>An accomplished Horse rider, Squash and badminton player, marathon runner and an artist.</li>
                                        <li>Awarded many Prestigious Orations and Presented and Chaired many sessions and papers in National.</li>
                                        <li>Awarded many Prestigious Orations and Presented and Chaired many sessions and papers in National.</li>
                                    </ul>
                ...
                <aside class="col-lg-4 col-md-4 col-sm-12 col-12 pl-lg-5 pl-md-5 pl-sm-2 pl-2">
                    <div class="sidebar-widget">
                        <h5 class="widget-title">Get Appointment</h5>
                        <!-- end widget tittle-->
                        <div class="appointment-form">
                            <form action="#">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <input name="aphone" class="form-control" id="aphone" placeholder="Your Phone Number" required="required" type="text">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <input type="text" id="datepicker" class="form-control" name="adate" placeholder="Click Calender Icon">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <textarea rows="6" name="rmessage" class="form-control" id="adescription" placeholder="Your Message" required="required"></textarea>
                                    </div>
                    ...
                    <!-- end widget -->
                    <div class="sidebar-widget">
                        <h5 class="widget-title">Related Doctors</h5>
                        <!-- end widget tittle-->
